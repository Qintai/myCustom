...
namespace QinOpen.IApplicationBuilderExtend
{
    ...
    {
        public static void InjectionBusinessServer(this IServiceCollection services, IConfiguration configuration)
        {

            //string InterExample= Appsettings.app("~/IApplicationBuilderExtend/InjectionBusinessServer.json", "InterExample");
            //string InterExample= Appsettings.app(@"E:\LC\myCustom\open\QinOpen\QinOpen\IApplicationBuilderExtend\InjectionBusinessServer.json", "InterExample");
            string InterExample = Appsettings.GetConfig("InjectionBusinessServer.json", "InterExample");
        ...
        //        var assemblye =
        //            assemblies.Where(k => k.FullName.Contains("QinServices")).FirstOrDefault(); //操作程序集 QinServices
        ...
        //                    services.AddTransient(inter, item); //左边是接口 右边是实现类
        //        }
        //        services.AddTransient(typeof(MessageModel));
        ...
        //            .Where(m => m.FullName.Contains("QinServices"))
        //            .ToList();
