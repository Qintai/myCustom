...
namespace Ruanmou.Redis.Exchange.Init
{
    ...
    internal class RedisManager
    {
        ...
        /// </summary>
        internal static readonly string RedisSysCustomKey = Appsettings.app(new string[] { "AppSettings", "RedisSysCustomKey" });
        /// <summary>
        /// 当前连接的Redis中的DataBase索引，默认0-16，可以在service.conf配置，最高64
        /// </summary>
        internal static readonly int RedisDataBaseIndex = int.Parse(Appsettings.app(new string[] { "AppSettings", "RedisDataBaseIndex" }));
        /// <summary>
        /// 当前连接的Redis中连接字符串，格式为：127.0.0.1:6379,allowadmin=true,passowrd=pwd
        /// </summary>
        internal static readonly string RedisHostConnection = Appsettings.app(new string[] { "RedisHostConnection" });
